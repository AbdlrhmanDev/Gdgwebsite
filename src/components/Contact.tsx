        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-8">
              {[
                { icon: Mail, color: "#4285f4", title: "Email", value: "gdg@mustaqbal.edu" },
                { icon: MapPin, color: "#34a853", title: "Location", value: "Mustaqbal University, Student Center" },
                { icon: Phone, color: "#f9ab00", title: "Phone", value: "+966 XX XXX XXXX" },
                { icon: MessageSquare, color: "#ea4335", title: "Social Media", value: "@gdg_mustaqbal" }
              ].map((item, index) => {
                ...
                return (
                  <motion.div 
                    ...
                    className="flex items-center gap-6 group p-4 rounded-2xl hover:bg-muted/50 transition-colors cursor-default"
                  >
                    <div 
              ...
              <div className="flex gap-4 flex-wrap">
                {["Twitter", "Instagram", "LinkedIn", "YouTube"].map((platform, index) => {
                  ...
                  return (
                    <button
                      key={platform}
                      className="px-6 py-3 rounded-full text-white text-sm font-medium transition-all hover:shadow-lg hover:-translate-y-1"
          ...
          >
            ...
            <form className="space-y-6 relative z-10">
              ...
              <Button className="w-full h-14 bg-[#4285f4] hover:bg-[#3367d6] text-white rounded-xl text-lg font-medium shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02]">
